...
## OUTPUT
<img width="902" height="155" alt="image" src="https://github.com/user-attachments/assets/fc7e0bb4-752c-4d86-8933-85b85c833127" />

## RESULT
Thus,a Python program to **count the number of triangles** present in an **undirected graph** using matrix operations is successfully executed.
